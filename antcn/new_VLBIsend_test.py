...
def matchlo(sumlo):
    ...
    # 3.6cm SFK
        if sumlo==8110:
          ...
          IFfreq=150
    # 18cm PFK
        elif sumlo==1510 or sumlo==1110:
          rxsetup="P180mm_vlbi1660"
          IFfreq=150
          if sumlo==1110:
            IFfreq=550
    # 18cm PFK
        elif sumlo==1515 or sumlo==1115:
          rxsetup="P180mm_vlbi1665"
          IFfreq=150
          if sumlo==1110:
            IFfreq=550
    # 18cm PFK 1606 MHz
        elif sumlo==1456 or sumlo==1460 or sumlo==1056:
          rxsetup="P180mm_vlbi1606"
          IFfreq=150
          if sumlo==1056:
            IFfreq=550
    # 6cm SFK
        elif sumlo >= 4100 and sumlo <= 5000:
          rxsetup="S60mm_vlbi"
          IFfreq=750
    # 5cm PFK
        elif sumlo>=5100 and sumlo<=6000:
          rxsetup="P50mm_vlbi"
          IFfreq=750
    # 2cm SFK
        elif sumlo==14600:
